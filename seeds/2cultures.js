...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('cultures').insert({
        ...
        header_img: '/image/1somalia.png',
        phrases_link: '/image/1somalia_phrases.png',
    ...
    knex('cultures').insert({
        ...
        header_img: '/image/1burma.png',
        phrases_link: '/image/1burma_phases.png',
    ...
    knex('cultures').insert({
        ...
        header_img: '/image/1bhutan.png',
        phrases_link: '/image/1bhutan_phrases.png',
    ...
    knex('cultures').insert({
        ...
        header_img: '/image/1sudan.png',
        phrases_link: '/image/1sudan_phrases.png',
    ...
    knex('cultures').insert({
        ...
        header_img: '/image/1iraq.png',
        phrases_link: '/image/1iraq_phrases.png',
