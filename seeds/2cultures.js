...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('cultures').insert({
        ...
        header_img: '../src/client/image/somaila.png',
        phrases_link: '../src/client/image/somaila_phrases.png',
    ...
    knex('cultures').insert({
        ...
        header_img: '../src/client/image/burma.png',
        phrases_link: '../src/client/image/burma_phrases.png',
    ...
    knex('cultures').insert({
        ...
        header_img: '../src/client/image/bhutan.png',
        phrases_link: '../src/client/image/bhutan_phrases.png',
    ...
    knex('cultures').insert({
        ...
        header_img: '../src/client/image/sudan.png',
        phrases_link: '../src/client/image/sudan_phrases.png',
    ...
    knex('cultures').insert({
        ...
        header_img: '../src/client/image/iraq.png',
        phrases_link: '../src/client/image/iraq_phrases.png',
